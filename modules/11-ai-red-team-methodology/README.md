...
Create a repeatable approach to AI security testing.

## Key message

AI red teaming should produce engineering decisions, not just screenshots of jailbreaks.
...
Perform a full attack chain against a vulnerable AI assistant.
