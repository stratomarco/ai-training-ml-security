...
Teach how ML systems are built before teaching how they break.

## Key message

In ML systems, data becomes part of the program. A compromised dataset can become compromised behavior.
...
Map assets and trust boundaries in a simple ML pipeline.
...
ML lifecycle data-flow diagram.
