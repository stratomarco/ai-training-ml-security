...
## AI security frameworks connected to this module
...
1. BIML Results page
2. BIML Interactive ML Risk Framework
3. BIML LLM architectural risk analysis
4. Gary McGraw, *Software Security: Building Security In*
5. Adam Shostack, *Threat Modeling: Designing for Security*
6. OWASP LLM Top 10
7. MITRE ATLAS overview

## Instructor note

This module should not become a history lesson. Use the references to reinforce one practical message:

> AI security review should start at architecture and design, not only after a model is deployed.
